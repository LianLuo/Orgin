...
namespace XTime.Wolf.Commons
{
    ...
    public sealed class HardwareInfoHelper
    {
        ...
        private static extern int GetVolumeInformation(string lpRootPathName, string lpVolumeNumeBuffer, int nVolumeNameSize, ref int lpVolumeSerialNumber, int lpMaximumComponentLength, int lpFilesSystemFlags, string lpFilesSystemNameBuffer, int nFileSystemNameSize);

        /// <summary>
        /// 功能描述：获取盘符drvID的硬盘序列号，缺省为C
        /// 创建时间：2016-06-28 
        /// 创建作者：luolian
        /// </summary>
